...
- The approved quantitative-system roadmap is phased: phase one adds a Qlib-backed A-share daily research and backtesting layer while preserving the FastAPI/React cockpit; vn.py is deferred to a later, separately approved execution and risk-control phase. Phase one must never create, route, or simulate live orders.
