export const copy = {
  en: {
    ...
    account: {
      ...
      errors: { email_registered: "This email already has an account.", invalid_credentials: "Email or password is incorrect.", email_invalid: "Enter a valid email address.", password_length_invalid: "Password must contain 10–128 characters.", generic: "Account request failed. Please try again." },
    },
    provider: "Provider",
  ...
  zh: {
    ...
    account: {
      ...
      errors: { email_registered: "该邮箱已经注册。", invalid_credentials: "邮箱或密码不正确。", email_invalid: "请输入有效邮箱。", password_length_invalid: "密码须为 10–128 个字符。", generic: "账户请求失败，请重试。" },
    },
    provider: "数据源",
