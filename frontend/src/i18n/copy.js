export const copy = {
  en: {
    ...
    markets: { CN: "A-shares", HK: "Hong Kong", US: "U.S.", WATCHLIST: "Watchlist" },
    watchlist: { scope: "Watchlist", add: "Add to watchlist", remove: "Remove from watchlist", saved: "Saved", empty: "No saved equities are available", loading: "Loading saved equities…", unavailable: (tickers) => `Quote unavailable for ${tickers.join(", ")}`, loadError: "Could not load saved equities." },
    account: {
      login: "Log in", register: "Register", logout: "Log out", email: "Email", password: "Password", close: "Close account dialog",
      loginTitle: "Log in to QuantDesk", registerTitle: "Create a QuantDesk account", description: "Save a private watchlist across sessions.",
      submitLogin: "Log in", submitRegister: "Create account", submitting: "Please wait…", switchToLogin: "Already have an account? Log in", switchToRegister: "No account? Register",
      forgotPassword: "Forgot password?", resetRequestTitle: "Reset your password", resetConfirmTitle: "Choose a new password", resetRequestDescription: "Enter your email and we will send a reset link if an account exists.", resetConfirmDescription: "Set a new password for your QuantDesk account.", submitResetRequest: "Send reset link", submitResetConfirm: "Save new password", resetRequestSent: "If this email has an account, a reset link has been sent.",
      passwordHint: "Use 10–128 characters.",
      errors: { email_registered: "This email already has an account.", invalid_credentials: "Email or password is incorrect.", email_invalid: "Enter a valid email address.", password_length_invalid: "Password must contain 10–128 characters.", password_reset_invalid: "This reset link is invalid or has expired.", generic: "Account request failed. Please try again." },
    },
    provider: "Provider",
  ...
  zh: {
    ...
    rankingList: "股票排名",
    marketScope: "市场范围",
    markets: { CN: "A股", HK: "港股", US: "美股", WATCHLIST: "自选" },
    watchlist: { scope: "自选", add: "加入自选", remove: "移除自选", saved: "已自选", empty: "暂无可展示的自选股票", loading: "正在加载自选股票…", unavailable: (tickers) => `暂无法获取行情：${tickers.join("、")}`, loadError: "自选股票加载失败。" },
    account: {
      login: "登录", register: "注册", logout: "退出登录", email: "邮箱", password: "密码", close: "关闭账户窗口",
      loginTitle: "登录 QuantDesk", registerTitle: "创建 QuantDesk 账户", description: "登录后即可跨会话保存私有自选股。",
      submitLogin: "登录", submitRegister: "创建账户", submitting: "请稍候…", switchToLogin: "已有账户？去登录", switchToRegister: "没有账户？去注册",
      forgotPassword: "忘记密码？", resetRequestTitle: "重置密码", resetConfirmTitle: "设置新密码", resetRequestDescription: "输入邮箱；如该邮箱已注册，系统会发送重置链接。", resetConfirmDescription: "请为你的 QuantDesk 账户设置新密码。", submitResetRequest: "发送重置链接", submitResetConfirm: "保存新密码", resetRequestSent: "如该邮箱已注册，重置链接已发送。",
      passwordHint: "密码须为 10–128 个字符。",
      errors: { email_registered: "该邮箱已经注册。", invalid_credentials: "邮箱或密码不正确。", email_invalid: "请输入有效邮箱。", password_length_invalid: "密码须为 10–128 个字符。", password_reset_invalid: "重置链接无效或已失效。", generic: "账户请求失败，请重试。" },
    },
    provider: "数据源",
